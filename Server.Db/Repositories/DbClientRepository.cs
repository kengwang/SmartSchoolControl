...
public class DbRepository<TEntity, TKey> : IRepository<TEntity, TKey> where TEntity : class
{
    protected virtual DbSet<TEntity> Table => _context.Set<TEntity>();
    private readonly ServerDbContext _context;

    public DbRepository(ServerDbContext context)
    {
        _context = context;
    }
